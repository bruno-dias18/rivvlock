const CACHE_NAME = 'rivvlock-v5';
const OLD_CACHE_NAMES = ['rivvlock-v1', 'rivvlock-v2', 'rivvlock-v3', 'rivvlock-v4'];
...
self.addEventListener('activate', (event) => {
  ...
  event.waitUntil(
    Promise.all([
      ...
      console.log('🔧 [SW] Service worker v5 activated and controlling all clients');
    })
  );
});
