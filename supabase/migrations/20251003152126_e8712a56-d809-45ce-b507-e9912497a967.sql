-- Security fix: Consolidate profiles RLS policies (CORRECTED VERSION)
-- This reduces 11+ overlapping policies to 5 clear, strict policies

-- ============================================================================
-- 1. DROP ALL EXISTING POLICIES (including partially created ones)
-- ============================================================================
...
-- Drop any partially created new policies from failed migration
...
-- Policy 5: DELETE - Nobody can delete profiles directly
...
-- ============================================================================
-- 4. DOCUMENTATION & DEFENSE IN DEPTH
-- ============================================================================

COMMENT ON TABLE public.profiles IS 
'User profiles with PII. RLS: users see only their own data, admins see all with audit logging. 5 consolidated policies.';

COMMENT ON FUNCTION public.can_access_full_profile(uuid) IS 
'Security: returns true if user owns profile or is admin. Admin access auto-logged.';
