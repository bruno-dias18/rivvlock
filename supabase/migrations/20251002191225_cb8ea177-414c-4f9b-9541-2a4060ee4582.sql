-- Activer RLS sur toutes les tables critiques (si pas déjà fait)
...
-- Recréer les politiques SELECT pour bloquer explicitement l'accès anonyme

-- PROFILES : Bloquer tout accès anonyme
...
-- STRIPE_ACCOUNTS : Bloquer tout accès anonyme
...
-- TRANSACTIONS : Bloquer tout accès anonyme
...
-- ADMIN_ROLES : Bloquer tout accès anonyme
...
-- INVOICES : Bloquer tout accès anonyme
...
-- DISPUTES : Bloquer tout accès anonyme
...
-- TRANSACTION_MESSAGES : Bloquer tout accès anonyme
...
-- DISPUTE_MESSAGES : Bloquer tout accès anonyme
