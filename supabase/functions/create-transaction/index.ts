...
serve(async (req) => {
  ...
  try {
    ...
    // Create transaction (shared_link_token will be auto-generated by DB default)
    ...
    // Extract the auto-generated URL-safe token
    const sharedLinkToken = transaction.shared_link_token;
    
    if (!sharedLinkToken) {
      throw new Error('Failed to generate shared link token');
    }
